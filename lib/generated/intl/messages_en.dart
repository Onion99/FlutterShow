...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m24(total) => "${total} products";

  static String m25(date) => "Valid til ${date}";

  static String m26(message) => "Warning: ${message}";

  static String m27(default_currency) =>
      "The currently selected currency is not available for the Wallet feature, please change it to ${default_currency}";

  static String m28(length) => "We found ${length} products";

  static String m29(week) => "Week ${week}";

  static String m30(year) => "${year} years ago";

  static String m31(total) => "You have assigned to order #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "warning": m26,
        "warningCurrencyMessageForWallet": m27,
        "weFoundBlogs":
