...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m24(total) => "${total} 个产品";

  static String m25(date) => "有效期至 ${date}";

  static String m26(message) => "警告: ${message}";

  static String m27(default_currency) =>
      "当前选择的货币不适用于电子钱包功能，请将其更改为 ${default_currency}";

  static String m28(length) => "我们找到 ${length} 个产品";

  static String m29(week) => "周 ${week}";

  static String m30(year) => "${year} 年前";

  static String m31(total) => "您已指定订单 #${total}";
