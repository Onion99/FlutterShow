...
class _WebViewInAppState extends State<WebViewInApp> {
  ...
  @override
  void dispose() {
    if (DefaultConfig.advanceConfig['inAppWebView']) {
    ...
    return Scaffold(
      ...
      body: InAppWebView(
        ...
        initialUrlRequest: URLRequest(
          url: Uri.parse(
            '${widget.url}${DefaultConfig.advanceConfig['inAppWebView'] ? '${widget.url.paramSymbol}dummy=${DateTime.now().millisecondsSinceEpoch}' : ''}',
          ),
