...
import 'package:flutter_show/widget/common/webview_inapp.dart';
import 'package:flutter_show/widget/html/index.dart';
import 'package:flutter_show/widget/loading/loading.dart';
...
mixin WebviewMixin {
  Future<NavigationDecision> getNavigationDelegate(
    ...
    await Tools.launchURL(request.url, mode: LaunchMode.externalNonBrowserApplication);
...
class _WebViewState extends State<WebView> with WebviewMixin,AppBarMixin {
  ...
  @override
  void dispose() {
    if (DefaultConfig.alwaysClearWebViewCache) {
  ...
  Widget build(BuildContext context) {
    ...
    return renderScaffold(
        ...
        body: Builder(builder: (context) {
          ...
          /// is Mobile or Web
          if (!kIsWeb && DefaultConfig.advanceConfig['inAppWebView']) {
            return WebViewInApp(
              url: url,
              title: widget.title,
                            ...
                            IconButton(
                              ...
                              onPressed: () async {
                                ...
                                if (value) {
                                  ...
                                  Tools.showSnackBar(ScaffoldMessenger.of(buildContext), S.of(context).noBackHistoryItem);
                                }
                              },
                            ),
                          if (widget.enableForward)
                            IconButton(
                              onPressed: () async {
                                if (await _controller?.canGoForward() ?? false) {
                                  ...
                                  Tools.showSnackBar(ScaffoldMessenger.of(buildContext), S.of(context).noForwardHistoryItem);
                                }
                              },
                              icon:
